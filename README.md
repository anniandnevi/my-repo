...
```
npm create cloudflare@latest -- --template=cloudflare/templates/misty-math-2db3
```

## Preview Deployment

A live public deployment of this template is available at [https://misty-math-2db3.templates.workers.dev](https://misty-math-2db3.templates.workers.dev)
